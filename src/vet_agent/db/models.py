...
class InputSafetyCandidateDefinitionModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="候选定义内部主键。"
    )
    code: Mapped[str] = mapped_column(
        Text, nullable=False, comment="候选编码，用于 OPA 策略、审计和安全信号关联。"
    )
    category: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="候选类别，例如完整性、提示注入、未开放能力或业务范围候选。",
    )
    ...
    message: Mapped[str] = mapped_column(
        Text, nullable=False, comment="候选默认说明，用于审计和默认安全响应。"
    )
    detector: Mapped[str] = mapped_column(
        Text, nullable=False, comment="候选来源检测器或结构化字段检查器标识。"
    )
...
class OutputSafetyCandidateDefinitionModel(Base):
    ...
    category: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="候选类别，例如系统提示泄露、PII、密钥、剂量、药物、主题边界或格式候选。",
    )
    default_severity: Mapped[str] = mapped_column(
        Text,
        nullable=False,
    ...
    message: Mapped[str] = mapped_column(
        Text, nullable=False, comment="候选默认说明，用于审计和默认策略原因。"
    )
    detector: Mapped[str] = mapped_column(
        Text, nullable=False, comment="候选来源检测器标识。"
    )
    priority: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
...
class ConsultationDomainModel(Base):
    ...
    domain: Mapped[str] = mapped_column(
        Text, primary_key=True, comment="问诊领域稳定技术标识。"
    )
...
class TaskRoutingDomainModel(Base):
    ...
    domain: Mapped[str] = mapped_column(
        Text, primary_key=True, comment="任务域稳定技术标识。"
    )
    title: Mapped[str] = mapped_column(
        Text, nullable=False, comment="任务域面向用户展示的标题。"
    )
    description: Mapped[str] = mapped_column(
        Text, nullable=False, comment="任务域职责说明，仅用于路由上下文和运维理解。"
    )
    priority: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
...
class ConsultationSlotModel(Base):
    ...
    slot_name: Mapped[str] = mapped_column(
        Text, primary_key=True, comment="问诊槽位稳定技术标识。"
    )
    question: Mapped[str] = mapped_column(
        Text, nullable=False, comment="该槽位默认追问文案。"
    )
    label: Mapped[str] = mapped_column(
        Text, nullable=False, comment="该槽位面向用户展示的中文标签。"
    )
    priority: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
...
class KnowledgeChunkModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="知识片段内部主键。"
    )
    source: Mapped[str] = mapped_column(
        Text, nullable=False, comment="知识来源名称或治理来源标识。"
    )
    title: Mapped[str] = mapped_column(
        Text, nullable=False, comment="知识片段标题，用于 RAG 证据展示与审计。"
    )
    content: Mapped[str] = mapped_column(
        Text, nullable=False, comment="知识片段正文内容。"
    )
    embedding: Mapped[list[float] | None] = mapped_column(
        Vector(),
        nullable=True,
        comment="pgvector embedding 向量，生产 RAG 召回主路径。",
    )
    public_citation: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        default=True,
        server_default="true",
        comment="是否允许作为公开引用证据展示。",
    )
    ...
    review_status: Mapped[str] = mapped_column(
        ...
        comment="知识片段审核状态，线上召回仅使用 approved。",
    )
    ...
    last_reviewed_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="知识片段最近审核时间。"
    )
    disabled_reason: Mapped[str | None] = mapped_column(
        Text, comment="知识片段被停用的运维原因。"
    )
    ingestion_batch: Mapped[str | None] = mapped_column(
        Text, comment="知识片段导入批次标识。"
    )
    metadata_json: Mapped[dict[str, Any]] = mapped_column(
        "metadata",
        JSONB,
        ...
        default=dict,
        server_default="{}",
        comment="知识片段附加治理元数据，例如 chunk_type 与条件标识。",
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
...
class ClinicalSafetyAssetModel(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "asset_id <> ''", name="ck_clinical_safety_assets_asset_id_nonempty"
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            ...
            name="ck_clinical_safety_assets_emergency_code_namespace",
        ),
        Index(
    ...
    asset_id: Mapped[str] = mapped_column(
        Text, primary_key=True, comment="临床安全资产稳定标识。"
    )
    code: Mapped[str] = mapped_column(
        Text, nullable=False, comment="对外安全信号编码，用于审计、策略和响应输出。"
    )
    asset_type: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="安全资产类型，例如毒物、人用药、急症红旗或隐匿风险模式。",
    )
    canonical_name: Mapped[str] = mapped_column(
        Text, nullable=False, comment="资产规范名称。"
    )
    category: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        default="",
        server_default="",
        comment="资产所属临床分类或原始资料分类。",
    )
    species_scope: Mapped[list[str]] = mapped_column(
        ARRAY(Text),
        nullable=False,
        default=list,
        server_default="{}",
    ...
    sex_scope: Mapped[list[str]] = mapped_column(
        ARRAY(Text),
        nullable=False,
        default=list,
        server_default="{}",
    ...
    age_scope: Mapped[list[str]] = mapped_column(
        ARRAY(Text),
        nullable=False,
        default=list,
        server_default="{}",
    ...
    severity: Mapped[str] = mapped_column(
        Text, nullable=False, comment="资产默认安全严重级别。"
    )
    action_class: Mapped[str] = mapped_column(
        Text, nullable=False, comment="资产默认分诊动作分类。"
    )
    aliases: Mapped[list[str]] = mapped_column(
        ...
        default=list,
        server_default="{}",
        comment="资产别名、英文名、商品名或俗称。",
    )
    carriers: Mapped[list[str]] = mapped_column(
        ARRAY(Text),
        nullable=False,
        default=list,
        server_default="{}",
    ...
    user_expressions: Mapped[list[str]] = mapped_column(
        ARRAY(Text),
        nullable=False,
        default=list,
        server_default="{}",
        comment="用户常见表达列表，仅用于资产治理和向量文本生成。",
    )
    ...
    required_context: Mapped[dict[str, Any]] = mapped_column(
        JSONB,
        nullable=False,
        default=dict,
        server_default="{}",
        comment="资产需要的结构化上下文提示。",
    )
    decision_hints: Mapped[dict[str, Any]] = mapped_column(
        JSONB,
        nullable=False,
        default=dict,
        server_default="{}",
        comment="不同语义场景下的策略动作提示。",
    )
    clinical_risk_summary: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default="", comment="临床风险摘要。"
    )
    triage_message: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        default="",
        server_default="",
    ...
    raw_text: Mapped[dict[str, Any]] = mapped_column(
        JSONB,
        nullable=False,
        default=dict,
        server_default="{}",
        comment="原始临床安全文本字段备份。",
    )
    version: Mapped[str] = mapped_column(
        Text, nullable=False, default="v1", server_default="v1", comment="资产版本。"
    )
    enabled: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        ...
        comment="资产是否允许运行时使用；发布动作必须显式置为 true。",
    )
    review_status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        ...
        comment="资产审核状态，线上召回仅使用 approved。",
    )
    published_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="资产发布时间。"
    )
    metadata_json: Mapped[dict[str, Any]] = mapped_column(
        "metadata",
        JSONB,
...
class ClinicalSafetyChunkModel(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "chunk_id <> ''", name="ck_clinical_safety_chunks_chunk_id_nonempty"
        ),
        CheckConstraint(
    ...
    chunk_id: Mapped[str] = mapped_column(
        Text, primary_key=True, comment="临床安全向量 chunk 稳定标识。"
    )
    asset_id: Mapped[str] = mapped_column(
        Text,
    ...
    chunk_type: Mapped[str] = mapped_column(
        Text, nullable=False, comment="chunk 用途类型，例如识别、临床风险或分诊动作。"
    )
    title: Mapped[str] = mapped_column(Text, nullable=False, comment="chunk 标题。")
    embedding_text: Mapped[str] = mapped_column(
        Text, nullable=False, comment="生成向量使用的标准文本。"
    )
    embedding: Mapped[list[float] | None] = mapped_column(
        Vector(1024),
        nullable=True,
        comment="pgvector embedding 向量，线上候选召回主路径。",
    )
    embedding_model: Mapped[str | None] = mapped_column(
        Text, comment="生成 embedding 使用的模型名称。"
    )
    embedding_dimension: Mapped[int | None] = mapped_column(
        Integer, comment="embedding 向量维度。"
    )
    content_hash: Mapped[str] = mapped_column(
        ...
        default="",
        server_default="",
        comment="embedding_text 的内容哈希。",
    )
    version: Mapped[str] = mapped_column(
        Text, nullable=False, default="v1", server_default="v1", comment="chunk 版本。"
    )
    enabled: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        default=False,
        server_default="false",
        comment="chunk 是否允许运行时召回；发布动作必须显式置为 true。",
    )
    review_status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        default="pending",
        server_default="pending",
        comment="chunk 审核状态，线上召回仅使用 approved。",
    )
    metadata_json: Mapped[dict[str, Any]] = mapped_column(
        "metadata",
        JSONB,
...
class KnowledgeIngestionBatchModel(Base):
    ...
    asset_type: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        default="clinical_conditions",
        server_default="clinical_conditions",
    )
    ...
    total_conditions: Mapped[int] = mapped_column(
...
class ClinicalConditionCardModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "version",
            "ingestion_batch",
            name="uq_clinical_condition_cards_batch_key",
        ),
    )
    ...
    differentials: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
    )
    ...
    red_flags_escalate: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
    )
    medication_direction: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
    )
    home_advice: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
    )
    source: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
...
class ConversationTurnModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="对话回合内部主键。"
    )
    turn_id: Mapped[str] = mapped_column(
        Text, nullable=False, unique=True, comment="Agent 生成的稳定回合标识。"
    )
    request_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="入口请求标识，用于幂等与 trace 关联。"
    )
    trace_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="链路追踪标识。"
    )
    user_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信用户标识。")
    session_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="可信会话标识。"
    )
    pet_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信宠物标识。")
    input_text: Mapped[str] = mapped_column(
        Text, nullable=False, comment="本轮用户输入文本快照。"
    )
    summary: Mapped[str] = mapped_column(
        Text, nullable=False, comment="本轮 Agent 响应摘要或完整输出快照。"
    )
    status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
...
class PetProfileModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="宠物画像内部主键。"
    )
    user_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="宠物所属用户标识，来自可信上游或宠物资料领域。"
    )
    pet_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="宠物标识，作为业务侧宠物范围主键。"
    )
...
class PetSessionBindingModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="会话绑定内部主键。"
    )
    session_id: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="会话标识，一个 session 只能绑定到同一用户与宠物。",
    )
    user_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="会话绑定的用户标识。"
    )
    pet_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="会话绑定的宠物标识。"
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
...
class ConsultationStateModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "session_id",
            "task_key",
            name="uq_consultation_states_scope",
        ),
        {
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="问诊状态内部主键。"
    )
    user_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信用户标识。")
    pet_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信宠物标识。")
    session_id: Mapped[str] = mapped_column(
...
class PetMemoryFactModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "user_id", "pet_id", "fact_type", "fact_key", name="uq_pet_memory_facts_key"
        ),
        {
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="长期事实内部主键。"
    )
    user_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信用户标识。")
    pet_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信宠物标识。")
    fact_type: Mapped[str] = mapped_column(
        Text, nullable=False, comment="事实类型，例如 medical 或 owner_preference。"
    )
    ...
    valid_until: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="事实失效时间。"
    )
    is_active: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
...
class PetMemoryEpisodeModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="episode 内部主键。"
    )
    user_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信用户标识。")
    pet_id: Mapped[str] = mapped_column(Text, nullable=False, comment="可信宠物标识。")
    session_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="episode 来源会话标识。"
    )
...
class PetReportModel(Base):
    ...
    __table_args__ = (UniqueConstraint("report_id", name="uq_pet_reports_report_id"),)
    ...
    status: Mapped[str] = mapped_column(
        Text, nullable=False, default="parsed", server_default="parsed"
    )
...
class RagRetrievalMissModel(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_rag_retrieval_misses_scope",
        ),
        CheckConstraint(
        ...
        Index(
            "idx_rag_retrieval_misses_domain_created_at", "task_domain", "created_at"
        ),
    ...
    id: Mapped[int] = mapped_column(
        ...
        primary_key=True,
        autoincrement=True,
        comment="RAG 无命中治理记录内部主键。",
    )
    miss_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="RAG 无命中治理记录稳定标识。"
    )
    request_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的 Agent 请求标识。"
    )
    trace_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的链路追踪标识。"
    )
    user_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="当前可信用户标识。"
    )
    pet_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="当前可信宠物标识。"
    )
    session_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="当前可信会话标识。"
    )
    rag_scope: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="RAG 无命中所属数据链范围，当前允许 answer_rag、followup_rag。",
    )
    task_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的当前任务展示标识。"
    )
    task_key: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的当前任务状态键。"
    )
    task_domain: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的当前任务域。"
    )
    task_title: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发无命中的当前任务标题。"
    )
    user_text_excerpt: Mapped[str] = mapped_column(
        Text, nullable=False, comment="经裁剪后的用户任务文本片段，用于人工治理排障。"
    )
    user_text_digest: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="用户任务文本 SHA-256 摘要，用于去重和隐私友好的聚合。",
    )
    ...
    failure_reason: Mapped[str] = mapped_column(
        Text, nullable=False, comment="无命中失败原因，例如 no_approved_vector_hits。"
    )
    error_type: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发治理记录的原始异常类型。"
    )
    error_message: Mapped[str] = mapped_column(
        Text, nullable=False, comment="触发治理记录的原始异常消息。"
    )
    ...
    dedupe_key: Mapped[str] = mapped_column(
        Text, nullable=False, comment="用于后台聚合同类知识缺口的稳定哈希键。"
    )
    status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
    ...
    linked_ingestion_batch: Mapped[str | None] = mapped_column(
        Text, comment="关联的知识导入批次标识。"
    )
...
class BackgroundTaskModel(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "task_type", "business_key", name="uq_background_tasks_type_business_key"
        ),
        CheckConstraint(
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="后台任务内部主键。"
    )
    task_id: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="后台任务稳定标识，用于响应 metadata、worker 审计和外部排障。",
    )
    task_type: Mapped[str] = mapped_column(
        Text, nullable=False, comment="后台任务类型，例如 memory_candidate_extraction。"
    )
    business_key: Mapped[str] = mapped_column(
        Text, nullable=False, comment="后台任务业务幂等键，同一任务类型下必须唯一。"
    )
    ordering_key: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="后台任务顺序约束键，例如 user_id:pet_id:session_id。",
    )
    user_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="任务来源用户标识。"
    )
    pet_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="任务来源宠物标识。"
    )
    session_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="任务来源会话标识。"
    )
    source_turn_id: Mapped[str | None] = mapped_column(
        Text, comment="任务来源回合标识。"
    )
    source_request_id: Mapped[str | None] = mapped_column(
        Text, comment="任务来源请求标识。"
    )
    source_trace_id: Mapped[str | None] = mapped_column(
        Text, comment="任务来源链路追踪标识。"
    )
    status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
    ...
    locked_by: Mapped[str | None] = mapped_column(
        Text, comment="当前持有任务租约的 worker 标识。"
    )
    locked_until: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="当前任务租约过期时间。"
    )
    payload: Mapped[dict[str, Any]] = mapped_column(
        JSONB,
        nullable=False,
    ...
    result: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, comment="任务执行结果或失败摘要。"
    )
    last_error: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, comment="最近一次失败的结构化错误信息。"
    )
    metadata_json: Mapped[dict[str, Any]] = mapped_column(
        "metadata",
        JSONB,
    ...
    started_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="任务首次或最近一次开始执行时间。"
    )
    finished_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), comment="任务最终完成时间。"
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
...
class IdempotencyRecordModel(Base):
    ...
    id: Mapped[int] = mapped_column(
        BigInteger, primary_key=True, autoincrement=True, comment="幂等记录内部主键。"
    )
    user_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="本轮可信身份范围中的用户标识。"
    )
    pet_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="本轮可信身份范围中的宠物标识。"
    )
    session_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="本轮可信身份范围中的会话标识。"
    )
    idempotency_key: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="调用方提交的幂等键，在同一用户、宠物、会话范围内唯一。",
    )
    request_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="最近一次声明或完成该幂等记录的请求标识。"
    )
    trace_id: Mapped[str] = mapped_column(
        Text, nullable=False, comment="最近一次声明或完成该幂等记录的链路追踪标识。"
    )
    ...
    response_id: Mapped[str | None] = mapped_column(
        Text, comment="首个成功响应的 Agent turn 标识。"
    )
    status: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="幂等记录状态，仅允许 processing、completed、failed。",
    )
    response_snapshot: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, comment="首个成功响应的 JSON 快照，用于后续同语义请求重放。"
    )
    error_type: Mapped[str | None] = mapped_column(
        Text, comment="最近一次执行失败的异常类型，用于排障和审计。"
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True),
        nullable=False,
