...
class BamlSyncClient:
    ...
    def ExtractV8Macro(self, messages_json: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractV8Macro", args={
...
class BamlStreamClient:
    ...
    def ExtractV8Macro(self, messages_json: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.V8MacroSemanticOutput, types.V8MacroSemanticOutput]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractV8Macro", args={
            "messages_json": messages_json,
        })
        return baml_py.BamlSyncStream[stream_types.V8MacroSemanticOutput, types.V8MacroSemanticOutput](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractV8Macro(self, messages_json: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractV8Macro", args={
            "messages_json": messages_json,
        }, mode="request")
        return __result__
