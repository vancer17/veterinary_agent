...
> **文档状态**：已由 V9 change summary 执行完毕；作为历史实验计划保留。当前架构与后续实验以
...
> 和 [input-preprocessing-v11-candidate-view-reranking-experiment-plan.md](/home/vancer17/veterinary_agent/docs/architecture/input-preprocessing-v11-candidate-view-reranking-experiment-plan.md)
> 为准。
>
> **定位**：V9 是 V8 blocker 的专项归因轮次，不是新的运行时架构，也不是生产消费准入。
>
